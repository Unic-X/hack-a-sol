...
The dataset used for this analysis is sourced from [Kaggle]((https://www.kaggle.com/datasets/kalaikumarr/cricket-series-ranking/data)) or other open-source platforms. Ensure the dataset is placed in the `data/` directory before executing the analysis.
